...
import { useUser } from '../context/UserContext.jsx'; // Import useUser hook
...
function ShiftManagerPage() { // Renamed from HomePage
...
export default ShiftManagerPage; // Renamed from HomePage
